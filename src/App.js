...
function App() {
  useEffect(() => {
    // Initialize plugins after component mounts and scripts are loaded
    const initializePlugins = () => {
      // Wait a bit for DOM to be fully rendered
      setTimeout(() => {
        // If jQuery is available, use it to run the template's initialization
        if (window.jQuery) {
          // Trigger document ready handlers if they haven't run yet
            ...
            document.querySelectorAll('.product-carousel').forEach((carousel) => {
              ...
              if (swiperEl && !swiperEl.swiper) {
                new window.Swiper(swiperEl, {
                  ...
                  spaceBetween: 20,
                  navigation: {
                    nextEl: carousel.querySelector('.icon-arrow-right'),
                    prevEl: carousel.querySelector('.icon-arrow-left')
                  },
                  pagination: {
    ...
    window.addEventListener('load', initializePlugins);

    return () => {
      // Cleanup
      window.removeEventListener('load', initializePlugins);
    };
  }, []);
    ...
    <div className="search-popup-container">
      ...
      <form role="search" method="get" className="form-group" action="">
        ...
        <button type="submit" className="search-submit border-0 position-absolute bg-white"
          style={{top: "15px", right: "15px"}}><svg className="search" width="24" height="24">
            <use href="#search"/>
          </svg></button>
      </form>
        ...
        <div className="swiper-wrapper d-flex">
          ...
          <div className="swiper-slide">
            <div className="product-item image-zoom-effect link-effect">
              <div className="image-holder position-relative">
                <a href="index.html">
                  <img src="/images/product-item-10.jpg" alt="categories" className="product-image img-fluid"/>
                </a>
                <a href="index.html" className="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use href="#heart"/>
        ...
        <div className="swiper-wrapper d-flex">
          ...
          <div className="swiper-slide">
            <div className="product-item image-zoom-effect link-effect">
              <div className="image-holder">
                <a href="index.html">
                  <img src="/images/product-item-3.jpg" alt="product" className="product-image img-fluid"/>
                </a>
                <a href="index.html" className="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use href="#heart"/>
          ...
          <div className="swiper-slide">
            <div className="product-item image-zoom-effect link-effect">
              <div className="image-holder">
                <a href="index.html">
                  <img src="/images/product-item-5.jpg" alt="categories" className="product-image img-fluid"/>
                </a>
                <a href="index.html" className="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use href="#heart"/>
          ...
          <div className="swiper-slide">
            <div className="product-item image-zoom-effect link-effect">
              <div className="image-holder">
                <a href="index.html">
                  <img src="/images/product-item-6.jpg" alt="categories" className="product-image img-fluid"/>
                </a>
                <a href="index.html" className="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use href="#heart"/>
          ...
          <div className="swiper-slide">
            <div className="product-item image-zoom-effect link-effect">
              <div className="image-holder">
                <a href="index.html">
                  <img src="/images/product-item-9.jpg" alt="categories" className="product-image img-fluid"/>
                </a>
                <a href="index.html" className="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use href="#heart"/>
        ...
        <div className="swiper-wrapper d-flex">
          <div className="swiper-slide">
            <div className="product-item image-zoom-effect link-effect">
              <div className="image-holder">
                <a href="index.html">
                  <img src="/images/product-item-5.jpg" alt="product" className="product-image img-fluid"/>
                </a>
                <a href="index.html" className="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use href="#heart"/>
          ...
          <div className="swiper-slide">
            <div className="product-item image-zoom-effect link-effect">
              <div className="image-holder">
                <a href="index.html">
                  <img src="/images/product-item-6.jpg" alt="product" className="product-image img-fluid"/>
                </a>
                <a href="index.html" className="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use href="#heart"/>
          ...
          <div className="swiper-slide">
            <div className="product-item image-zoom-effect link-effect">
              <div className="image-holder">
                <a href="index.html">
                  <img src="/images/product-item-7.jpg" alt="product" className="product-image img-fluid"/>
                </a>
                <a href="index.html" className="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use href="#heart"/>
          ...
          <div className="swiper-slide">
            <div className="product-item image-zoom-effect link-effect">
              <div className="image-holder">
                <a href="index.html">
                  <img src="/images/product-item-8.jpg" alt="product" className="product-image img-fluid"/>
                </a>
                <a href="index.html" className="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use href="#heart"/>
          ...
          <div className="swiper-slide">
            <div className="product-item image-zoom-effect link-effect">
              <div className="image-holder">
                <a href="index.html">
                  <img src="/images/product-item-1.jpg" alt="product" className="product-image img-fluid"/>
                </a>
                <a href="index.html" className="btn-icon btn-wishlist">
                  <svg width="24" height="24" viewBox="0 0 24 24">
                    <use href="#heart"/>
